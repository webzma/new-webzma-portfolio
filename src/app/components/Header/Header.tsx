...
export function Header() {
  return (
    <header className="fixed top-0 w-full left-0 flex items-center justify-between py-4 px-48 font-[family-name:var(--font-geist-sans)] z-10 bg-white/40 backdrop-blur">
